...
COPY --from=BUILD /usr/src/app/target/transitdata-mqtt-sink-jar-with-dependencies.jar /usr/app/transitdata-mqtt-sink.jar

ENTRYPOINT ["java", "-jar", "/usr/app/transitdata-mqtt-sink.jar"]
